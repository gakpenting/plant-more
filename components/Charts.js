...
export default function Map() {
  ...
  return (
    <>
      ...
      <div
        class="container mx-auto flex sm:flex-nowrap flex-wrap items-center justify-center"
        style={{ display: error.state ? "block" : "none" }}
      >
        <div class="alert alert-error">
          <div class="flex-1">
            <label class="mx-3">{error.message}</label>
          </div>
          <div class="flex-none">
            <button class="btn btn-sm btn-ghost mr-2" onClick={closeMessage}>
              Close
            </button>
          </div>
        </div>
        ...
        <div class="container px-5 py-5 mx-auto flex sm:flex-nowrap flex-wrap">
          ...
          <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
            ...
            <div class="relative mb-4">
              ...
              <select onChange={(e)=>setPickStartYear(e.target.value)} class="select select w-full max-w-xs">
            ...
            <div class="relative mb-4">
              ...
              <select onChange={(e)=>setPickEndYear(e.target.value)} class="select select w-full max-w-xs">
