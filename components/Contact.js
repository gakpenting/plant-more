            ...
            <div className="flex flex-wrap -m-2">
              ...
              <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                ...
                <span className="inline-flex">
                  <a href="https://twitter.com/spiritbrother" target="_blank" className="ml-4 text-gray-500">
                    <svg
                      fill="currentColor"
                      strokeLinecap="round"
                  ...
                  <a href="https://github.com/spiritbro1" target="_blank" className="ml-4 text-gray-500">
                    <img width="18" src="/github.png" />
                  </a>
                </span>
              </div>
            </div>
